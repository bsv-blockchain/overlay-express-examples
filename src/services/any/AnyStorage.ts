...
export class AnyStorage {
  ...
  /**
   * Stores a new Any record in the database.
  ...
  /**
   * Updates a Any record that matches the given transaction ID and output index.
   * 
   * @param txid 
   * @param outputIndex 
   * @param spendingTxid 
  ...
  /**
   * Deletes a Any record that matches the given transaction ID and output index.
  ...
  /**
   * Finds Any records containing the specified txid (case-insensitive).
  ...
  /**
   * Retrieves all Any records, optionally filtered by date range and sorted by creation time.
